...
Java_com_example_vuforiamuseum_vuforia_VuforiaARSession_initAR(
    JNIEnv *env,
    jobject /* this */,
    jobject activity,
    ...
    jint target)
{
    ...
    gWrapperData.presentErrorMethodID = env->GetMethodID(clazz, "errorInitializingVuforiaAR", "(Ljava/lang/String;)V");
    gWrapperData.initDoneMethodID = env->GetMethodID(clazz, "vuforiaARInitialized", "()V");
...
Java_com_example_vuforiamuseum_vuforia_VuforiaARSession_startAR(
        JNIEnv *env,
        jobject /* this */)
{
...
JNIEXPORT void JNICALL
Java_com_example_vuforiamuseum_vuforia_VuforiaARSession_pauseAR(
        JNIEnv *env,
        jobject /* this */)
{
    controller.pauseAR();
...
JNIEXPORT void JNICALL
Java_com_example_vuforiamuseum_vuforia_VuforiaARSession_resumeAR(
        JNIEnv *env,
        jobject /* this */)
{
    controller.resumeAR();
...
JNIEXPORT void JNICALL
Java_com_example_vuforiamuseum_vuforia_VuforiaARSession_stopAR(
    JNIEnv *env,
    jobject /* this */)
{
    controller.stopAR();
...
JNIEXPORT void JNICALL
Java_com_example_vuforiamuseum_vuforia_VuforiaARSession_deinitAR(
        JNIEnv *env,
        jobject /* this */)
{
    controller.deinitAR();
...
JNIEXPORT void JNICALL
Java_com_example_vuforiamuseum_vuforia_VuforiaARSession_cameraPerformAutoFocus(
    JNIEnv *env,
    jobject /* this */)
{
...
JNIEXPORT void JNICALL
Java_com_example_vuforiamuseum_vuforia_VuforiaARSession_cameraRestoreAutoFocus(
    JNIEnv *env,
    jobject /* this */)
{
...
JNIEXPORT void JNICALL
Java_com_example_vuforiamuseum_vuforia_VuforiaARSession_initRendering(
        JNIEnv *env,
        jobject /* this */)
{
    // Define clear color
...
JNIEXPORT void JNICALL
Java_com_example_vuforiamuseum_vuforia_VuforiaARSession_setTextures(
    JNIEnv *env,
    jobject /* this */,
...
JNIEXPORT void JNICALL
Java_com_example_vuforiamuseum_vuforia_VuforiaARSession_deinitRendering(
    JNIEnv *env,
    jobject /* this */)
{
...
JNIEXPORT jboolean JNICALL
Java_com_example_vuforiamuseum_vuforia_VuforiaARSession_configureRendering(
        JNIEnv *env,
        jobject /* this */,
...
Java_com_example_vuforiamuseum_vuforia_VuforiaARSession_renderFrame(
        JNIEnv *env,
        jobject /* this */)
{
    ...
    /* variável que guarda o estado de detecção da imagem que queremos detectar. */
    jstring imageTargetDetected = nullptr;
...
//        }
        ...
        const char *detected = controller.getImageTargetResult(
                trackableProjection,
                trackableModelView,
                trackableModelViewScaled);

        imageTargetDetected = env->NewStringUTF(detected);
...
//        }
    ...
    //return JNI_TRUE;
    return imageTargetDetected;
}


JNIEXPORT jint JNICALL
Java_com_example_vuforiamuseum_vuforia_VuforiaARSession_getImageTargetId(
    JNIEnv *env,
    jobject /* this */)
{
...
JNIEXPORT jint JNICALL
Java_com_example_vuforiamuseum_vuforia_VuforiaARSession_getModelTargetId(
    JNIEnv *env,
    jobject /* this */)
{
